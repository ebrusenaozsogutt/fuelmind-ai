...
public sealed partial class ReportsViewModel(IReportService reportService, IStationService stationService) : ObservableObject
{
    private static readonly IReadOnlyDictionary<string, IReadOnlyList<ReportColumnDefinition>> ColumnSets =
        new Dictionary<string, IReadOnlyList<ReportColumnDefinition>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["sales"] = [
                new("sale_id", "Satış ID", 80, 70, 90, UsePixelWidth: true),
                new("timestamp", "Tarih / Saat", 150, 140, 160, UsePixelWidth: true),
                new("station", "İstasyon", 200, 180, 220, UsePixelWidth: true),
                new("pump", "Pompa", 160, 120, 180, UsePixelWidth: true),
                new("nozzle", "Tabanca", 190, 150, 220, UsePixelWidth: true),
                new("attendant", "Pompacı", 145, 130, 160, UsePixelWidth: true),
                new("shift", "Vardiya", 100, 90, 110, UsePixelWidth: true),
                new("fuel_type", "Ürün", 100, 90, 110, UsePixelWidth: true),
                new("liters", "Litre", 90, 80, 100, IsNumeric: true, UsePixelWidth: true),
                new("start_totalizer", "Başlangıç Totalizer", 130, 120, 140, IsNumeric: true, UsePixelWidth: true),
                new("end_totalizer", "Bitiş Totalizer", 130, 120, 140, IsNumeric: true, UsePixelWidth: true),
                new("unit_price", "Birim Fiyat", 100, 90, 110, IsNumeric: true, UsePixelWidth: true),
                new("total_amount", "Tutar", 110, 100, 120, IsNumeric: true, UsePixelWidth: true),
                new("customer", "Müşteri", 200, 180, 220, UsePixelWidth: true),
                new("plate", "Plaka", 110, 100, 120, UsePixelWidth: true),
                new("card", "Kart", 160, 140, 180, UsePixelWidth: true),
                new("payment_type", "Ödeme", 110, 100, 120, UsePixelWidth: true),
                new("sale_status", "Durum", 110, 100, 120, UsePixelWidth: true)],
